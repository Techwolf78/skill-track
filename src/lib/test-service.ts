...
export const testService = {
  ...
  getAutoGeneratedTemplates: async (signature: SignatureMetadata): Promise<LanguageTemplates> => {
    const response = await apiClient.post<LanguageTemplates>("/questions/codegen", signature);
    return unwrapResponse(response);
  },
};
