        ...
        <form onSubmit={handleExtend} className="mt-5 space-y-4">
          ...
          <div className="pt-2 flex items-center justify-end gap-2 border-t border-slate-100">
            ...
            <button
              ...
              className="px-4 py-2 text-xs font-semibold bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
