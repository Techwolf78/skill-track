  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="p-0 overflow-hidden max-w-[480px] border-none rounded-lg shadow-2xl flex flex-row min-h-[380px]">
        {/* Left Sidebar using Electric Indigo brand color and larger min-height */}
        <div className="w-[140px] bg-indigo-600 text-white p-5 flex flex-col justify-start select-none min-h-[380px]">
        ...
        <div className="flex-1 bg-white p-4 pt-10 flex flex-col justify-between min-h-[380px]">
          ...
          <div className="flex justify-end gap-4 mt-4 text-xs font-bold select-none">
            <button 
              type="button" 
              onClick={onClose} 
              className="text-indigo-600 hover:bg-indigo-50 px-3 py-2 rounded transition-colors"
            >
              CANCEL
            </button>
            <button 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="p-0 overflow-hidden max-w-[480px] border-none rounded-lg shadow-2xl flex flex-row min-h-[330px]">
        {/* Left Sidebar using Electric Indigo brand color */}
        <div className="w-[140px] bg-indigo-600 text-white p-5 flex flex-col justify-between select-none min-h-[330px]">
        ...
        <div className="flex-1 bg-white p-4 pt-10 flex flex-col items-center justify-between min-h-[330px]">
          ...
          <div className="w-48 h-48 rounded-full bg-slate-50 border relative flex items-center justify-center mt-2">
            {/* Center dot */}
            <div className="w-1.5 h-1.5 rounded-full bg-indigo-600 z-10" />
            ...
            <div 
              ...
              className="absolute w-[2px] bg-indigo-600 z-0 transition-transform duration-200"
            />
