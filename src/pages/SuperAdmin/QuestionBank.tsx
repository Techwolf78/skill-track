    ...
    const sampleJson = [
      {
        ...
        avg_time_seconds: 90,
        mcqOptions: [
          { text: "ConcurrentHashMap", imageUrl: "", isCorrect: true },
          { text: "HashMap", imageUrl: "", isCorrect: false },
          { text: "TreeMap", imageUrl: "", isCorrect: false },
          { text: "WeakHashMap", imageUrl: "", isCorrect: false },
        ],
      },
      {
        questionType: "CODING",
        ...
        sampleExplanation: "n = 10 -> 10 + 9 = 19",
