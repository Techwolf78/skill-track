            ...
            <div className="flex flex-wrap gap-1">
              {strongList.length > 0 ? (
                strongList.map((topic, i) => (
                  <span key={i} className="px-1.5 py-0.5 bg-slate-100 text-slate-800 border border-slate-200 text-[9px] font-semibold rounded">
                    {topic}
                  </span>
                ))
              ) : (
            ...
            <div className="flex flex-wrap gap-1">
              {weakList.length > 0 ? (
                weakList.map((topic, i) => (
                  <span key={i} className="px-1.5 py-0.5 bg-slate-50 text-slate-600 border border-slate-200 text-[9px] font-medium rounded">
                    {topic}
                  </span>
                ))
              ) : (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="p-3 bg-white border border-slate-200 rounded-md">
                          ...
                          <div className="text-xs text-slate-700 mt-1 flex items-center">
                            Stale Record: <span className={`ml-1.5 px-1.5 py-0.2 rounded text-[10px] font-semibold ${candidate.stale ? "bg-rose-50 text-rose-700 border border-rose-200" : "bg-slate-100 text-slate-700"}`}>{candidate.stale ? "Yes" : "No"}</span>
                          </div>
                        </div>
                        <div className="p-3 bg-white border border-slate-200 rounded-md">
